 ...
 */
const memimgRegistry = new WeakMap();
// ============================================================================
 ...
 * ```
 */
export const createMemoryImage = (root = {}, options = {}) => {
    ...
    const rootProxy = wrapIfNeeded(root, [], // Root path is empty array
    infrastructure, eventLog, replayState);
    // Step 3: Store infrastructure in global registry
    // Enables serialization and metadata queries without polluting the proxy
    memimgRegistry.set(rootProxy, infrastructure);
    return rootProxy;
};
// ============================================================================
// Serialization API
 ...
 * ```
 */
export const serializeMemoryImageToJson = (root) => {
    const infrastructure = memimgRegistry.get(root);
    if (!infrastructure) {
 ...
 * ```
 */
export const deserializeMemoryImageFromJson = (json) => {
    return deserializeMemoryImage(json);
};
// ============================================================================
// Event Replay API
// ============================================================================
 ...
 * ```
 */
export const replayEventsToMemoryImage = async (events, options = {}) => {
 ...
 * ```
 */
export const replayEventsFromLog = async (options) => {
    if (!options.eventLog) {
 ...
 * ```
 */
export const getMemoryImageMetadata = (root) => {
    const infrastructure = memimgRegistry.get(root);
 ...
 * ```
 */
export const getMemoryImageInfrastructure = (root) => {
    return memimgRegistry.get(root) || null;
};
/**
 ...
 * ```
 */
export const isMemoryImage = (value) => {
    return (typeof value === "object" &&
        value !== null &&
        memimgRegistry.has(value));
};
// ============================================================================
...
//# sourceMappingURL=memimg.js.map
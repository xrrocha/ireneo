 ...
 */
export function isSerializedClassInstance(value) {
    return (typeof value === "object" &&
        value !== null &&
        TYPE_MARKERS.CLASS in value &&
        typeof value[TYPE_MARKERS.CLASS] === "string");
}
/**
...
export function getClassName(value) {
    return value[TYPE_MARKERS.CLASS];
}
/**
 ...
 */
export function reconstructInstance(plainObject, classRegistry) {
 ...
 */
export function getInstanceClassName(value) {
    const proto = Object.getPrototypeOf(value);
...
//# sourceMappingURL=instance-reconstructor.js.map
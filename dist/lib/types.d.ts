 ...
 */
export declare function toMutablePath(path: Path): MutablePath;
/**
 * Convert mutable array to immutable Path.
 *
 * Use this when passing navigation state to Ireneo functions.
 */
export declare function toPath(path: MutablePath): Path;
/**
...
export type Proxied<T> = T & {
    readonly __proxiedBrand: typeof ProxiedBrand;
};
/**
 ...
 * @template T The underlying type structure
 */
export type Target<T> = T & {
    readonly __targetBrand: typeof TargetBrand;
};
/**
 ...
 */
export type Unbranded<T> = T extends Proxied<infer U> ? U : T extends Target<infer U> ? U : T;
/**
 ...
 * ```
 */
export declare function asProxied<T>(value: T): Proxied<T>;
/**
 ...
 * ```
 */
export declare function asTarget<T>(value: T): Target<T>;
/**
 ...
 * ```
 */
export declare function unbrand<T>(value: Proxied<T> | Target<T> | T): Unbranded<T>;
/**
 * All possible event types in the system.
 */
export type EventType = "SET" | "DELETE" | "ARRAY_PUSH" | "ARRAY_POP" | "ARRAY_SHIFT" | "ARRAY_UNSHIFT" | "ARRAY_SPLICE" | "ARRAY_SORT" | "ARRAY_REVERSE" | "ARRAY_FILL" | "ARRAY_COPYWITHIN" | "MAP_SET" | "MAP_DELETE" | "MAP_CLEAR" | "SET_ADD" | "SET_DELETE" | "SET_CLEAR" | "SCRIPT";
/**
 ...
 */
export type Event = SetEvent | DeleteEvent | ArrayPushEvent | ArrayPopEvent | ArrayShiftEvent | ArrayUnshiftEvent | ArraySpliceEvent | ArraySortEvent | ArrayReverseEvent | ArrayFillEvent | ArrayCopyWithinEvent | MapSetEvent | MapDeleteEvent | MapClearEvent | SetAddEvent | SetDeleteEvent | SetClearEvent | ScriptEvent;
/**
 ...
 */
export type SerializedValue = SerializedPrimitive | SerializedReference | SerializedFunction | SerializedDate | SerializedBigInt | SerializedSymbol | SerializedMap | SerializedSet | SerializedArray | SerializedObject;
/**
 ...
 */
export declare const isSerializedReference: (value: unknown) => value is SerializedReference;
/**
 * Check if a value is an unresolved reference (during deserialization)
 */
export declare const isUnresolvedReference: (value: unknown) => value is UnresolvedReference;
/**
